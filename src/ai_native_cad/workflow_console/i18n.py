...
_COPY: dict[str, tuple[str, str]] = {
    ...
    "current_design": ("Current Design", "当前设计"),
    "new_design": ("New Design", "新建设计"),
    "start_product_example": ("Start Product Example", "开始产品示例"),
    "product_examples": ("Product examples", "产品示例"),
    "real_agent_example": ("Real Agent example", "真实 Agent 示例"),
    "completed_product_example": ("Completed product example", "已完成产品示例"),
    "show_developer_content": ("Show developer content", "显示开发者内容"),
    "credential_source": ("Credential source", "凭据来源"),
    "api_key": ("API Key", "API Key"),
    "model": ("Model", "模型"),
    "test_connection": ("Test connection", "测试连接"),
    "save_verify": ("Save & Verify", "保存并验证"),
    "connection_success": ("Connected successfully", "连接成功"),
    "connection_failed": ("Connection failed", "连接失败"),
    "connection_changed": ("Changed since last test", "配置已修改，需要重新测试"),
    "local_cad_execution": ("Local CAD Execution", "本地 CAD 执行"),
    "need_your_input": ("Need your input", "需要你的输入"),
    "open_settings": ("Open Settings", "打开设置"),
    "modify_design": ("Modify request", "修改设计"),
    "check_local_execution": ("Check local execution", "检查本地执行环境"),
    "technical_details": ("View technical details", "查看技术详情"),
    ...
    "your_request": ("Your Request", "你的要求"),
    "request_source_initial": ("Initial request", "初始要求"),
    "request_source_revision": ("Active revision request", "当前修改要求"),
    "visible_constraints": ("Constraints you supplied", "你提供的约束"),
    "agent_design": ("Agent Design", "Agent 设计"),
    "agent_design_evidence_gap": (
        "No concise persisted design summary exists for this attempt yet.",
        "当前尝试尚无可用的持久化设计摘要。",
    ),
    "design_concept": ("Design concept", "设计概念"),
    "geometry_strategy": ("Geometry strategy", "几何策略"),
    "important_parameters": ("Important parameters", "关键参数"),
    "functional_features": ("Functional features", "功能特征"),
    "interfaces": ("Interfaces", "接口"),
    "tradeoffs": ("Trade-offs", "取舍"),
    "source_capability_mode": ("Source capability mode", "来源能力模式"),
    "what_happened": ("What happened", "发生了什么"),
    "timeline_request_received": ("Read the design request", "读取设计要求"),
    "timeline_design_candidate": ("Created a design candidate", "创建设计候选"),
    "timeline_geometry_built": ("Built geometry", "生成几何"),
    "timeline_step_inspected": ("Inspected the generated STEP", "检查生成的 STEP"),
    "timeline_ready_review": ("Ready for review", "已准备好审查"),
    "reproducible_product_golden": (
        "Reproducible Product Golden",
        "可复现产品 Golden",
    ),
    "product_golden_scope": (
        "Scripted for reproducibility; this does not prove external-provider design quality.",
        "使用脚本保证可复现；这不证明外部 provider 的设计质量。",
    ),
    "open_product_example": ("Open Product Example", "打开产品示例"),
    "product_example_summary": (
        "Open a complete single-Part Job story with a scripted Agent, reviewable geometry, and explicit Accept or Revise.",
        "打开一个完整的单零件任务故事，其中包含脚本化 Agent、可审查几何以及明确的接受或修改操作。",
    ),
    "compatibility_examples": ("Compatibility examples", "兼容性示例"),
    ...
    "accepted_result_retained": (
        "Accepted result retained while revision begins",
        "开始修改时仍保留已接受结果",
    ),
    ...
    "not_requested": ("Not requested", "未要求"),
    ...
    "safely_stopped": ("Stopped safely without publishing a result", "已安全停止，未发布结果"),
    ...
    "design_runnable_parts": ("Design runnable Parts", "设计可运行的零件"),
...
_ACTION_LABELS: dict[str, str] = {
    ...
    "Design runnable Parts": "设计可运行的零件",
